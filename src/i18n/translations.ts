...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    gallery: {
      ...
      subtitle: 'Explore our templates built for real businesses. Click any one to see a live demo.',
      viewDemo: 'View Demo →',
    },
    ...
    success: {
      ...
      subtitle: "Thank you for your order. We'll start building your landing page within 24 hours.",
      ...
      step3Title: 'You review and approve',
      step3Desc: "We'll send you a preview link. Request any changes until you're 100% happy.",
  ...
  es: {
    ...
    gallery: {
      ...
      subtitle: 'Explora nuestras plantillas diseñadas para negocios reales. Haz clic en cualquiera para ver una demo en vivo.',
      viewDemo: 'Ver Demo →',
    },
    ...
    orderForm: {
      ...
      payButton: 'Pagar con Tarjeta — $40',
      or: 'o',
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Qué métodos de pago aceptan?', a: 'Tarjetas de crédito/débito vía Stripe y PayPal. Todos los pagos son seguros y encriptados.' },
    ...
    success: {
      title: '¡Pago Exitoso!',
      subtitle: 'Gracias por tu pedido. Comenzaremos a crear tu página dentro de 24 horas.',
      ...
      step3Desc: 'Te enviaremos un enlace de vista previa. Solicita cambios hasta que estés 100% satisfecho.',
  ...
  pt: {
    ...
    gallery: {
      ...
      subtitle: 'Explore nossos modelos criados para negócios reais. Clique em qualquer um para ver uma demo ao vivo.',
      viewDemo: 'Ver Demo →',
    },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Quais métodos de pagamento vocês aceitam?', a: 'Cartões de crédito/débito via Stripe e PayPal. Todos os pagamentos são seguros e criptografados.' },
    ...
    success: {
      ...
      subtitle: 'Obrigado pelo seu pedido. Começaremos a criar sua página dentro de 24 horas.',
      ...
      step3Title: 'Você revisa e aprova',
      step3Desc: 'Enviaremos um link de visualização. Solicite alterações até estar 100% satisfeito.',
